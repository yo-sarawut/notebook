  ...
  var textReplies = function () {
    switch (textInputValueLowerCase) {
      ...
      case "code":
        clearInput();
        addTextToResults(
          "Get web elements source code at <a target='_blank' href='https://webdevtrick.com'>WebDevTrick</a>"
        );
        break;
      ...
      case "shaan":
        clearInput();
        addTextToResults(
          "Shaan is founder of this blog and he is a Developer, SEO, and Graphic Designer"
        );
        break;
      ...
      case "hola":
        clearInput();
        addTextToResults(
          "Hello, I am your assistant... I am based on pure JavaScript."
        );
        break;
